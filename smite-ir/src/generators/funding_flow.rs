...
/// Emits [`FundingFlowGenerator`]'s flow, returning the `ChannelId` variable
/// of the channel it opens.
pub(super) fn append_funding_flow(builder: &mut ProgramBuilder, rng: &mut impl Rng) -> usize {
